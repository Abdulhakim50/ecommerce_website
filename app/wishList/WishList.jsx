...
const WishList = ({item}) => {
  ...
  return (
    ...
    <tr class="hover:bg-gray-100">
      ...
      <td class="py-4 px-6 text-left border-b">
        <button class="text-red-500 hover:underline" onClick={() =>  handleRemoveWishList(item)}><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 text-red-900">
