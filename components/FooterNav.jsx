...
<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 text-white" onClick={router.push('/')}>
...
<div className='flex flex-col text-center items-center  mt-2'>
        <ShowCartQty className="w-7 h-7 text-white font-black " Qty=" absolute top-[-2px] right-[-0px] text-white bg-green-950 h-3 w-3 rounded-full  flex item-center justify-center text-[10px]"  onClick={router.push('/cart')} />
        <p className='text-white text-sm'>Cart</p>
        </div>

        <div className='flex flex-col items-center mt-3'>
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 text-white"  onClick={router.push('/categoryList')} >
