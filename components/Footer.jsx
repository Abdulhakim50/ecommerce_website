...
const Footer = () => {
  return (
    <footer className="bg-gray-800 text-white  mb-8 py-12 md:mt-60">
      <div className="container mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8 max-sm:gap-4">
