...
<div id="drawer-example" class="fixed top-0 left-0 z-40 h-screen bg-[#333333]  p-4 overflow-y-auto transition-transform -translate-x-full  w-80  items-center  overflow-y: scroll;" tabindex="-1" aria-labelledby="drawer-label">
